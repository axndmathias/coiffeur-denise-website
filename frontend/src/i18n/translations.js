    ...
    categories: [
      {
        ...
        items: [
          { name: "Braut-Probetermin", desc: "Beratung und Probestyling vor der Hochzeit.", price: "Auf Anfrage" },
          { name: "Hochzeitstag – Braut", desc: "Komplettes Brautstyling für Ihren Tag.", price: "Auf Anfrage" },
          { name: "Styling Brautjungfer", desc: "Elegantes Styling passend zur Hochzeitsgesellschaft.", price: "Auf Anfrage" },
          { name: "Styling Blumenmädchen", desc: "Süsses Styling für Ihre kleinsten Gäste.", price: "Auf Anfrage" },
      ...
      },
      {
        ...
        items: [
          { name: "Make-up + Haar (Ball / Event)", desc: "Haarstyling & Make-up für Bälle und Events.", price: "Auf Anfrage" },
    ...
    categories: [
      {
        ...
        image: IMAGES.bridal,
        items: [
          { name: "Bridal Hair Trial", desc: "Pre-wedding consultation & trial styling.", price: "On request" },
          { name: "Wedding Day - Bride", desc: "Complete bridal hair styling for your day.", price: "On request" },
          { name: "Bridesmaid Styling", desc: "Elegant styling to match your bridal party.", price: "On request" },
          { name: "Flower Girl Styling", desc: "Sweet styling for your littlest guests.", price: "On request" },
